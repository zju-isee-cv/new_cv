...
cell_list{1,4} = {'Extract grid corners manually',['check_click_calib;'...
		    'if ~missing '...
		    '[gridInfo,paramEst3D]  ='...
		    'new_grid_extraction(images,gen_KK_est,gridInfo,paramEst3D);'...
		    'end']};

cell_list{2,1} = {'Initialize and assign RT',['check_click_calib;'...
		    'if ~missing '...
		    'paramEst3D  ='...
		    'new_est_RT(gridInfo, gen_KK_est, paramEst3D);'...
		    'end']};
...
cell_list{3,1} = {'Draw Grid Estimate',['check_click_calib;'...
		  'if ~missing '...
		  'new_drawImageWithPoints(images,gen_KK_est,gridInfo,paramEst3D);'...
		  'end']};
