...
function [P,dPdV] = omniCamProjection3D(X, V)  %reprojection, this is important
...
% P = spaceToNPlane3D(P,V(8));
% P = spaceToNPlane3D(P,V(8),V(9),V(10));
P = spaceToNPlane3D(P,V(8:11),V(12:14));
% P = distortion(P, V(9:13));
%  P = distortion(P, V(11:15));
P = distortion(P, V(15:19));
% P = NPlaneToImgPlane(P, V(14:18));
% P = NPlaneToImgPlane(P, V(16:20));
P = NPlaneToImgPlane(P, V(20:24));
